...
class MainLayout(QWidget):
    def __init__(self, parent=None):
        ...
        input_label = QLabel(_("Tipe:"))
        self.search_type_combo = QComboBox()
        self.search_type_combo.addItems([_("Video"), _("Playlist"), _("Channel")])
        self.search_type_combo.setToolTip(_("Pilih jenis input jika bukan URL pasti"))
        input_label.setBuddy(self.search_type_combo)
        input_layout.addWidget(input_label)
        input_layout.addWidget(self.search_type_combo)

        self.go_button = QPushButton(_("Go!"))
        self.go_button.setObjectName("go_button")
        input_layout.addWidget(self.go_button)
        main_layout.addLayout(input_layout)

        action_buttons_layout = QHBoxLayout()
        self.settings_button = QPushButton(_("Pengaturan..."))
        ...
        self.status_label = QLabel(_("Siap. Masukkan URL atau kata kunci."))
