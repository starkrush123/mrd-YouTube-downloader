...
- **Riwayat Unduhan:** Menambahkan tab "Riwayat Download" baru di jendela utama untuk menampilkan daftar semua unduhan yang telah selesai.
- Setiap entri riwayat menampilkan judul, tanggal unduh, dan tombol untuk "Buka File" dan "Buka Folder".
- Riwayat disimpan dalam file `history.json` di direktori data aplikasi.

### Perbaikan & Peningkatan

- Memperbaiki masalah yang menyebabkan pemutar media tidak berfungsi dengan baik, termasuk perbaikan tampilan layar penuh.
...
- Memperbaiki masalah pemutar media yang tidak berfungsi setelah perubahan tata letak UI.